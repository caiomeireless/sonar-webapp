    ...
    >
      ...
      >
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
          ...
          <div className="absolute left-1/2 top-1/2 h-[50%] w-[35%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--color-gold)]/10 blur-2xl" />
        </div>
        ...
        {showArrows && total > 1 && (
          <>
            <button
              ...
              onClick={goPrev}
              className="btn-neon-circle-gold absolute left-4 top-1/2 z-20 -translate-y-1/2"
            >
              <ChevronLeft />
            </button>
            <button
              ...
              onClick={goNext}
              className="btn-neon-circle-gold absolute right-4 top-1/2 z-20 -translate-y-1/2"
            >
              <ChevronRight />
            </button>
          </>
